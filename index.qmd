...
# Age-Stratified SHAP Analysis - Key findings

## Age-specific contribution to mortality prediction

- The SHAP contribution of age showed a clear **nonlinear pattern across adulthood**.
- At younger ages (approximately 18–44 years), age SHAP values were consistently negative and changed relatively little, indicating that younger age strongly shifted predictions toward lower mortality risk but contributed relatively little to **risk differentiation within this younger range**.
- Beginning around **45 years**, the contribution of age increased progressively with advancing age.
- Age SHAP values approached zero around the early 60s and became increasingly positive thereafter, indicating a progressively stronger contribution of older age toward predicted 2-year mortality.
- This pattern supported using approximately **45 years as a data-informed cutoff** for exploratory age-stratified interpretation.

## Figure 8. Contribution of Age to Predicted 2-Year Mortality

![Contribution of Age](images/age_contribution.png){#fig-id fig-alt="alt"}


## Comparison of non-age predictor importance (<45 vs. ≥45 years)

- The **six most important non-age predictors were highly consistent across age groups**: malignant cancer, chronic lung disease, heart failure, male sex, kidney disease, and other immunocompromised conditions.
- Malignant cancer had nearly identical importance in the two age groups.
- Chronic lung disease, heart failure, male sex, and kidney disease showed somewhat greater mean absolute SHAP contributions among adults ≥45 years.
- Differences were more apparent among lower-ranked predictors. Hypertension and mild liver disease contributed more strongly among adults <45 years, whereas some predictors, including congestive heart failure, had greater contributions among older adults.
- Overall, the results suggest that **the major clinical predictors of mortality are largely preserved across age groups, although their relative contributions vary with age.**

## Figure 9. Age-Stratified Predictor Importance

![Age-Stratified Predictor Importance](images/age_stratified_import.png){#fig-id fig-alt="alt"}
...
```{}
grid_glmnet_quick <- crossing(
  mixture = c(0, 0.1, 0.25, 0.5, 0.75, 1),
  penalty = 10^seq(-5, 0.5, length.out = 20)
)
```
...
- eval_time = c(90, 180, 365, 545, 730)
- refined grid based on the results of Stage 1 tuning

```{}
grid_glmnet_refined <- crossing(
  mixture = c(0, 0.10, 0.15, 0.25, 0.35, 0.50, 0.75, 1.00),
  penalty = 10^seq(-5, -2, length.out = 30)
)
```
...
Fit the final model based on the best parameters.

## RSF tuning strategy

- Full-set tuning
- Use mean_IBS as the main metrics for model selection
...
The research reported in this poster was supported by the AIM-AHEAD Coordinating Center at the University of North Texas Health Science Center at Fort Worth. This research was, in part, funded by the National Institutes of Health (NIH) Agreement No. 1OT2OD032581. The views and conclusions contained in this document are those of the authors and should not be interpreted as representing the official policies, either expressed or implied, of the NIH. The analyses described in this poster were conducted with data or tools accessed through the NCATS N3C Data Enclave https://n3c.ncats.nih.gov/clinical-cohort and N3C Attribution & Publication Policy v 1.2-2020-08-25b supported by NCATS Contract No. 75N95023D00001. This research was possible because of the patients whose information is included within the data and the organizations (https://ncats.nih.gov/n3c/resources/data-contribution/data-transfer-agreement-signatories) and scientists who have contributed to the ongoing development of this community resource https://doi.org/10.1093/jamia/ocaa196.
